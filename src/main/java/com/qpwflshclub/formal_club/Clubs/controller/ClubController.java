...
public class ClubController {
    ...
    private void guardClubText(UserBase user, ClubDTO dto) {
        ...
        moderation.inspect(
            ...
            dto.getClubDescriptionEn(),
            dto.getSortDescription(),
            dto.getSortDescriptionEn(),
            dto.getPresident(),
            dto.getPresidentEn(),
            dto.getVicePresident(),
            dto.getVicePresidentEn(),
            dto.getTeacher(),
            dto.getTeacherEn()
        );
    }
    ...
    @Autowired
    private ClubRepository likeClubs;
    ...
    @Autowired
    private PublicClubCatalog publicCatalog;
